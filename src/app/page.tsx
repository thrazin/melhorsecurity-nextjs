...
export default function HomePage() {
  ...
  return (
    <div className="relative bg-[#0d1117] text-slate-300 font-sans antialiased">
      {/* Imagem de fundo principal com overlay */}
      <div className="absolute inset-0 z-0 opacity-10">
        <Image src="/images/circuits.webp" alt="Fundo de circuitos" layout="fill" objectFit="cover" quality={80} />
      </div>
      ...
      <div className="relative z-10">
        ...
        <Dialog as="div" className="md:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-[#161b22] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
        ...
        <main>
          <section className="relative text-center py-20 md:py-32 px-4 flex flex-col items-center">
              <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-emerald-900/50 rounded-full filter blur-3xl animate-pulse"></div>
              <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-slate-900/50 rounded-full filter blur-3xl animate-pulse animation-delay-4000"></div>

              <h1 className="text-4xl md:text-6xl font-black text-white leading-tight">
                INVESTIMENTO EM <span className="text-emerald-400 neon-text-emerald">CIBERSEGURANÇA</span><br />E PROTEÇÃO DIGITAL
              </h1>
              ...
              <a href="#investimento" className="mt-10 inline-block bg-emerald-600 text-white font-bold py-4 px-10 rounded-lg transition-transform hover:scale-105 shadow-lg shadow-emerald-500/20">Quero aprender proteção digital</a>
          </section>

          <section id="beneficios" className="py-20 px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center"><h2 className="text-4xl md:text-5xl font-black text-white">Transforme sua <span className="text-emerald-400 neon-text-emerald">Vulnerabilidade</span> em <span className="text-emerald-400 neon-text-emerald">Fortaleza</span></h2><p className="text-lg mt-4 max-w-3xl mx-auto text-slate-400">Com a mentoria, você adquire habilidades práticas para se defender das ameaças digitais mais comuns.</p></div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800 transition-all hover:border-emerald-500 hover:scale-105"> <ShieldCheck className="text-emerald-400" size={32} /> <h3 className="text-xl font-bold mt-4 text-white">Blindar Redes Sociais</h3> <p className="text-slate-400 mt-2">Aprenda a ativar as barreiras que impedem a clonagem e a invasão de contas.</p> </div>
                ...
                <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800 transition-all hover:border-emerald-500 hover:scale-105"> <Search className="text-emerald-400" size={32} /> <h3 className="text-xl font-bold mt-4 text-white">Mestre em Identificar Golpes</h3> <p className="text-slate-400 mt-2">Em segundos, você saberá identificar um e-mail, SMS ou mensagem de WhatsApp falsa.</p> </div>
                <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800 transition-all hover:border-emerald-500 hover:scale-105"> <CreditCard className="text-emerald-400" size={32} /> <h3 className="text-xl font-bold mt-4 text-white">Compras Online e Pix Seguros</h3> <p className="text-slate-400 mt-2">Conheça o passo a passo para fazer compras e transferências sem cair em armadilhas.</p> </div>
                <div className="bg-slate-900/50 p-6 rounded-lg border border-slate-800 transition-all hover:border-emerald-500 hover:scale-105"> <Lock className="text-emerald-400" size={32} /> <h3 className="text-xl font-bold mt-4 text-white">Privacidade em Primeiro Lugar</h3> <p className="text-slate-400 mt-2">Aprenda a configurar seu celular para decidir quem pode ver suas informações e fotos.</p> </div>
          ...
          <section id="metodologia" className="py-20 px-4 bg-black/20 backdrop-blur-sm">
              <div className="max-w-4xl mx-auto relative">
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-0 opacity-5 animate-float">
                    <Image src="/images/lock.webp" alt="Cadeado digital" width={400} height={400} />
                  </div>
                  <div className="relative z-10 text-center"><h2 className="text-4xl md:text-5xl font-black text-white">Metodologia <span className="text-emerald-400 neon-text-emerald">Passo a Passo</span></h2><p className="text-lg mt-4 max-w-3xl mx-auto text-slate-400">Um plano de 4 etapas desenhado para te dar confiança e controle total da sua vida digital.</p></div>
          ...
          <section id="investimento" className="py-20 px-4">
              <div className="max-w-md mx-auto">
                  <div className="text-center"><h2 className="text-4xl md:text-5xl font-black text-white">Investimento na Sua <span className="text-emerald-400 neon-text-emerald">Tranquilidade Digital</span></h2><p className="text-lg mt-4 max-w-3xl mx-auto text-slate-400">Acesso único a um especialista para guiar seus passos no mundo da segurança digital.</p></div>
                  <div className="mt-10 bg-slate-900/50 border border-emerald-500/30 rounded-xl p-8 shadow-2xl shadow-emerald-500/10"><h3 className="text-xl font-bold text-white">Mentoria Completa em Segurança</h3><p className="text-slate-400 mt-2 line-through">De R$ 850,00</p><p className="text-5xl font-black text-white mt-1">Por R$ 450,00</p><p className="text-emerald-400 font-semibold">ou 12x de R$ 45,19</p><ul className="space-y-3 mt-6 text-slate-300"><li className="flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" />4 encontros de 1h ao vivo e individuais</li><li className="flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" />Análise de Risco e Conteúdo Personalizado</li><li className="flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" />Material de Apoio com Ferramentas e Guias</li><li className="flex items-center gap-2"><ShieldCheck size={16} className="text-emerald-500" />Suporte via WhatsApp por 60 dias pós-mentoria</li></ul><a href="#comprar-form" className="mt-8 block w-full text-center bg-emerald-600 text-white font-bold py-3 rounded-lg transition-transform hover:scale-105">Garantir Minha Vaga</a></div>
              </div>
              <div id="comprar-form" className="max-w-md mx-auto mt-12"><PaymentForm /></div>
          </section>
          
          <section id="faq" className="py-20 px-4 bg-black/20 backdrop-blur-sm">
